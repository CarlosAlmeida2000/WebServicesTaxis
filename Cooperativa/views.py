...
class Cooperativa(APIView):
    ...
    # GET con parámetros 
    # http://127.0.0.1:8000/cooperativa/?nom_cooperativa=San pedro
    # GET sin parámetros
    ...
    def get(self, request, format = None):
        if request.method == 'GET':
            try:
                ...
                return Response({'cooperativa': 'Sucedió un error al obtener los datos, por favor intente nuevamente.' + str(e)})
